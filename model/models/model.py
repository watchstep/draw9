...
class SimpleCNN(nn.Module):
    def __init__(self, input_size = 28, num_classes = 30):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(1, 32, 5, bias=False), nn.GeLU(inplace=True), nn.MaxPool2d(2,2))
        self.conv2 = nn.Sequential(nn.Conv2d(32, 64, 5, bias=False), nn.GeLU(inplace=True), nn.MaxPool2d(2, 2))
